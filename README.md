...
Ruff 是一个用 Rust 开发的 Python 代码检查和格式化工具，可以自定义和修正代码风格。它在团队开发中非常有用，能保证代码风格统一
...
个人最喜爱的 Python Web 框架，具有强大的能力和悠久的历史。今年是 Django 诞生的第 21 年，它依旧有着活跃的开发人员和维护人员。Instagram 一开始使用 Django 构建后端项目，而当用户突破百万时，依旧没有出现性能瓶颈，足见 Django 的强劲。
...
Google 开发的大规模容器管理与编排工具，已经成为容器编排领域的主流工具
